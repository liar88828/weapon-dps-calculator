...
import {
  ...
  TinyStat,
  TinyStatCompare,
} from "@/components/mini/tinyStat.tsx";
    ...
    <TooltipProvider>
      ...
      >
        <div className=" space-y-8">
          ...
          <WeaponCard
            weapon={compareWeapons.weapon1}
            onRemove={() => setCompareWeapons(null, compareWeapons.weapon2)}
            isWeapon1={true}
          />
          <WeaponCard
            weapon={compareWeapons.weapon2}
            onRemove={() => setCompareWeapons(compareWeapons.weapon1, null)}
            isWeapon1={false}
          />
          <WeaponCardCompare
            onSwap={() =>
              setCompareWeapons(compareWeapons.weapon2, compareWeapons.weapon1)
            }
            isWeapon1={false}
...
export function ListSavedWeaponDialog({ isWeapon1 }: { isWeapon1: boolean }) {
  const { weapons, compareWeapons, removeWeapon, setCompareWeapons } =
    useWeaponListStore();
...
export function WeaponCard({
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            You not select a weapon, or create first in{" "}
  ...
  const { criticalDps, criticalPlusElementDps, normalDps } =
    useDpsWeaponBasic(weapon);
  return (
    <TooltipProvider>
      <motion.div
        initial={{ opacity: 0, y: 8 }}
          ...
          <CardFooter className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              <Badge className="rounded-full" variant="outline">
                <Swords /> {fmt(weapon.multiplier, 2)} mult{" "}
              </Badge>
            </div>
            <div className="flex items-center gap-2">
              {actionsSlot}
        ...
        >
          <CardHeader className="space-y-1">
            <div className="flex items-center justify-between">
              ...
              <Badge
                ...
                className="rounded-full px-3 py-1 text-xs"
              >
                {weapon1.category} | {weapon2.category}
              </Badge>
            </div>
            <div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
              ...
              />
              <TinyStatCompare
                icon={<Music4Icon className="size-4" />}
                label="Magazine"
          ...
          <CardFooter className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              <Badge className="rounded-full text-red-400" variant="outline">
                <Swords />
                {fmt(weapon1.multiplier, 2)} mult
              </Badge>

              <Badge className="rounded-full text-blue-400" variant="outline">
                <Swords />
                {fmt(weapon2.multiplier, 2)} mult
              </Badge>
            </div>
            <div className="flex items-center gap-2">
              {actionsSlot}
...
export function WeaponListCompareOld({
  ...
  return (
    <div key={w.id} className="flex justify-between items-center border-b pb-1">
      ...
      <div className="flex gap-2 flex-col">
        <DialogClose asChild>
          <Button size="sm" onClick={() => removeWeapon(w.id)}>
